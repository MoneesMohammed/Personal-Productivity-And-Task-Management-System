...
{
    public partial class CtrlAddEditUserInfo : UserControl
    {
        ...
        public CtrlAddEditUserInfo(int UserID)
        {
            InitializeComponent();
            _UserID = UserID;
            _Mode = enMode.Update;
        ...
        private void CtrlAddEditUserInfo_Load(object sender, EventArgs e)
        {
            _ResatDefualtValues();
        ...
        private void _LoadData()
        {
            ...
            if (_User == null)
            {
                ...
                OnBack_Click?.Invoke(this, EventArgs.Empty);
                return;
            }
